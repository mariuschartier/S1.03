...
function main($files)
{
    ...
    foreach ($files as $numFile => $file) {
        ...
        $fileResources += [
            "define_fichier" . $numFile => $arrayDefine,
            "fonction_fichier" . $numFile => $arrayFunction,
            "structure_fichier" . $numFile => $arrayStructure,
        ];
    }
